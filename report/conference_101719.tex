...
For this paper we predominently followed these papers \cite{poker-vision}
\cite{opencv-card-detection}. Using these two resources we outlined a pipeline that we wanted to
follow, and possible deviations from it.
...
The limitations with our application are: the cards must not overlap and must not be slightly cut
from the frame. It detects the card within 
...
\bibitem{poker-vision} Poker Vision Paper here please
